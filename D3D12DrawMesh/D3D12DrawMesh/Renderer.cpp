...
void FRenderer::RenderScene(FDynamicRHI* RHI, FFrameResource* FrameRes)
{
	...
	// shadow pass
	{
		...
		{
			// use shadow pso
			RHI->SetPipelineState(i.MeshRes->ShadowMat->PSO.get());
	...
	// scene color pass
	{
		...
		{
			// pso
			RHI->SetPipelineState(i.MeshRes->SceneColorMat->PSO.get()); // use HDR pso
		...
		SCOPED_EVENT("Post Process");
		{
			SCOPED_EVENT("Bloom");
			{
				// bloom setup
				{
					...
					RHI->SetPipelineState(FrameRes->GetPostProcessTriangleRes()->BloomSetupMat->PSO.get());
				...
				// bloom down 1/4->1/8
				{
					...
					RHI->SetPipelineState(FrameRes->GetPostProcessTriangleRes()->BloomDownMat[0]->PSO.get());
				...
				// bloom down 1/8->1/16
				{
					...
					RHI->SetPipelineState(FrameRes->GetPostProcessTriangleRes()->BloomDownMat[1]->PSO.get());
				...
				// bloom down 1/16->1/32
				{
					...
					RHI->SetPipelineState(FrameRes->GetPostProcessTriangleRes()->BloomDownMat[2]->PSO.get());
				...
				// bloom down 1/32->1/64
				{
					...
					RHI->SetPipelineState(FrameRes->GetPostProcessTriangleRes()->BloomDownMat[3]->PSO.get());
				...
				// bloom up 1/64->1/32
				{
					...
					RHI->SetViewport(0.0f, 0.0f, static_cast<float>(RHI->GetWidth() / 32), static_cast<float>(RHI->GetHeight() / 32), 0.f, 1.f);
					RHI->SetScissor(0, 0, RHI->GetWidth() / 32, RHI->GetHeight() / 32);
					RHI->SetPipelineState(FrameRes->GetPostProcessTriangleRes()->BloomUpMat[0]->PSO.get());
				...
				// bloom up 1/32->1/16
				{
					...
					RHI->SetViewport(0.0f, 0.0f, static_cast<float>(RHI->GetWidth() / 16), static_cast<float>(RHI->GetHeight() / 16), 0.f, 1.f);
					RHI->SetScissor(0, 0, RHI->GetWidth() / 16, RHI->GetHeight() / 16);
					RHI->SetPipelineState(FrameRes->GetPostProcessTriangleRes()->BloomUpMat[1]->PSO.get());
				...
				// bloom up 1/16->1/8
				{
					...
					RHI->SetViewport(0.0f, 0.0f, static_cast<float>(RHI->GetWidth() / 8), static_cast<float>(RHI->GetHeight() / 8), 0.f, 1.f);
					RHI->SetScissor(0, 0, RHI->GetWidth() / 8, RHI->GetHeight() / 8);
					RHI->SetPipelineState(FrameRes->GetPostProcessTriangleRes()->BloomUpMat[2]->PSO.get());
				...
				// sun merge
				{
					...
					RHI->SetViewport(0.0f, 0.0f, static_cast<float>(RHI->GetWidth() / 4), static_cast<float>(RHI->GetHeight() / 4), 0.f, 1.f);
					RHI->SetScissor(0, 0, RHI->GetWidth() / 4, RHI->GetHeight() / 4);
					RHI->SetPipelineState(FrameRes->GetPostProcessTriangleRes()->SunMergeMat->PSO.get());
	...
	// tonemapping output
	{
		...
		RHI->SetViewport(0.0f, 0.0f, static_cast<float>(RHI->GetWidth()), static_cast<float>(RHI->GetHeight()), 0.f, 1.f);
		RHI->SetScissor(0, 0, RHI->GetWidth(), RHI->GetHeight());
		RHI->SetPipelineState(FrameRes->GetPostProcessTriangleRes()->ToneMappingMat->PSO.get());
